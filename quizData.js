const quizData = [
  ...
  {
    question: "Which standard is primarily used for high-speed local networks?",
  ...
  },
  {
    ...
    options: ["NAND chip", "DRAM cache", "Controller", "Error correction unit"],
  ...
  {
    question: "Which type of processor is better for battery-operated devices?",
    options: ["RISC", "CISC", "Both", "Neither"],
    correctAnswer: "RISC",
  },
  {
  ...
  {
    question: "What is a common tool for debugging assembly language programs?",
  ...
  {
    question: "Which component of a CPU temporarily holds data for execution?",
  ...
  },
  {
    ...
    options: ["Increased speed", "Redundancy", "Lower cost", "Larger capacity"],
  ...
  {
    question: "What is the primary purpose of the test command in I/O modules?",
    options: [
  ...
  },
  {
    ...
    options: ["Over-provisioning", "Capacitors", "Error correction", "Caching"],
